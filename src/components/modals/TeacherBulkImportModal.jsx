...
export default function TeacherBulkImportModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleDownloadTemplate = () => {
    ...
    const headers = ['No.', 'First Name', 'Middle Name', 'Last Name', 'Username', 'Email', 'Created At', 'Updated At'];
            ...
            >
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-sm font-mono text-gray-700 overflow-x-auto">
                  <div>No., First Name, Middle Name, Last Name, Username, Email, Password, Created At, Updated At</div>
                  <div className="text-xs text-gray-600 mt-2">
                    ...
                    • Created At, Updated At: Auto-generated by system<br />
